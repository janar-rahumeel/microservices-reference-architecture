...
@Getter
public class NewPersonCustomerV2 extends AbstractNewCustomerV2 {
    ...
    @Builder
    @JsonCreator
    public NewPersonCustomerV2(
            @JsonProperty("firstName") String firstName,
            @JsonProperty("lastName") String lastName,
            @JsonProperty("personalIdentificationCode") String personalIdentificationCode) {
        super();
