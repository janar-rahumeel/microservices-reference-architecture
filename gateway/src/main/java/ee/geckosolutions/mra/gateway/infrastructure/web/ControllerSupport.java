 ...
 */
package ee.geckosolutions.mra.gateway.infrastructure.web;
...
public class ControllerSupport { // any other location TODO ???
        ...
        headers.add(
                ...
                HTTP_DATE_FORMAT.format(
                        deprecatedSince.atZone(ZoneOffset.UTC)
                                .plus(applicationProperties.getApi().getDeprecationSunsetPeriod())
                                .toInstant()));
