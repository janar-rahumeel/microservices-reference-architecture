...
import ee.geckosolutions.mra.gateway.infrastructure.web.ControllerSupport;
...
public class CustomerV1Controller implements CustomerV1Api {
    ...
    public ResponseEntity<byte[]> get(@PathVariable UUID id) {
        Instant v1DeprecatedSince = applicationProperties.getApi().getCustomer().getV1DeprecatedSince();
