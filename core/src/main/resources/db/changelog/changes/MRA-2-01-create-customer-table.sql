...
--changeset codex:20260413-01-create-customer-table
--comment: Create customer table with unique and shape constraints
...
ALTER TABLE customer
    ADD CONSTRAINT chk_customer_shape CHECK (
        (type = 'PERSON'
