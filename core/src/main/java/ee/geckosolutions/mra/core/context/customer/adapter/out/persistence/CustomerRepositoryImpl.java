...
public class CustomerRepositoryImpl implements CustomerRepository {
    ...
    public Optional<Customer> findById(UUID id) {
        return this.jpaCustomerRepository.findById(id).map(CustomerRepositoryImpl::toDomain);
    }

    @Override
    public boolean existsPersonByPersonalIdentificationCode(String personalIdentificationCode) {
        return this.jpaCustomerRepository.existsByPersonalIdentificationCode(personalIdentificationCode);
    }

    @Override
    public boolean existsLegalEntityByRegistrationCode(String registrationCode) {
        return this.jpaCustomerRepository.existsByRegistrationCode(registrationCode);
    }

    @Override
    public Customer save(Customer customer) {
        CustomerEntity savedEntity = this.jpaCustomerRepository.save(toEntity(customer));
