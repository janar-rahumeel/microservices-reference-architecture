...
public class CustomerApplicationService {
    ...
    public Customer createPersonCustomer(String firstName, String lastName, String personalIdentificationCode) {
        ...
        if (this.customerRepository.existsPersonByPersonalIdentificationCode(customer.getPersonalIdentificationCode())) {
    ...
    public Customer createLegalEntityCustomer(String name, String registrationCode) {
        ...
        if (this.customerRepository.existsLegalEntityByRegistrationCode(customer.getRegistrationCode())) {
            throw new DuplicateCustomerException(
